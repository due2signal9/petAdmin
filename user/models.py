...
class PetUser(models.Model):
    ...
    password = models.CharField(u'密码', max_length=256, blank=True)
    gender = models.SmallIntegerField(u'性别', default=0)
    signature = models.CharField(u'个性签名', max_length=32, blank=True)
    last_login = models.DateTimeField(u'上次登录', blank=True)
